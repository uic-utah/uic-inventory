...
namespace api.Migrations
{
    ...
    [Migration("20240422193900_StatusRefactors")]
    partial class StatusRefactors
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "public", "notification_types", new[] { "new_user_account_registration", "admin_promotion", "inventory_submission", "inventory_authorized", "facility_contact_modified", "approved_well_status_edit", "approved_inventory_well_addition", "approved_site_contact_addition", "approved_site_contact_deletion" });
            ...
            modelBuilder.Entity("api.Features.Inventory", b =>
                {
                    ...
                    b.Property<int?>("CompletedByAccountId")
                        .HasColumnType("integer")
                    ...
                    b.Property<int?>("UnderReviewByAccountId")
                        .HasColumnType("integer")
                        .HasColumnName("under_review_by_account_id");

                    b.Property<DateTime?>("UnderReviewOn")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("under_review_on");
                    ...
                    b.HasIndex("ApprovedByAccountId")
                        .HasDatabaseName("ix_inventories_approved_by_account_id");

                    b.HasIndex("AuthorizedByAccountId")
                        .HasDatabaseName("ix_inventories_authorized_by_account_id");

                    b.HasIndex("CompletedByAccountId")
                        .HasDatabaseName("ix_inventories_completed_by_account_id");

                    b.HasIndex("SiteFk")
                        .HasDatabaseName("ix_inventory_site_fk");

                    b.HasIndex("UnderReviewByAccountId")
                        .HasDatabaseName("ix_inventories_under_review_by_account_id");
            ...
            modelBuilder.Entity("api.Features.Inventory", b =>
                {
                    ...
                    b.HasOne("api.Features.Account", "ApprovedByAccount")
                        .WithMany()
                        .HasForeignKey("ApprovedByAccountId")
                        .HasConstraintName("fk_inventories_accounts_approved_by_account_id");
                    ...
                    b.HasOne("api.Features.Account", "CompletedByAccount")
                        .WithMany()
                        .HasForeignKey("CompletedByAccountId")
                        .HasConstraintName("fk_inventories_accounts_completed_by_account_id");
                    ...
                    b.HasOne("api.Features.Account", "UnderReviewByAccount")
                        .WithMany()
                        .HasForeignKey("UnderReviewByAccountId")
                        .HasConstraintName("fk_inventories_accounts_under_review_by_account_id");
                    ...
                    b.Navigation("CompletedByAccount");

                    b.Navigation("Site");

                    b.Navigation("UnderReviewByAccount");
                });
