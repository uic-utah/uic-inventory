  ...
  return (
    <section>
      ...
      <p>
        ...
        <button meta="primary" onClick={history.goBack}>
          go back
        </button>{' '}
        to the previous page and try again or <Link meta="primary" to="/contact" replace={true}>
          contact us
        </Link>{' '} to share the technical details with us from below.
      </p>
  ...
  return (
    <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          <div
            className={`${loading ? 'min-h-screen md:min-h-profile' : 'h-full'
