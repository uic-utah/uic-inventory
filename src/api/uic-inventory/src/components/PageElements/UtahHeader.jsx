...
export const UtahHeader = ({ className, children }) => {
  return (
    <Collapsible.Root>
      <header className={className}>
        <div className="flex items-center justify-between border-b border-b-gray-800 px-3 pb-2 pt-1">
